...
## Next step
You have to log in with your Expo account in your terminal and your App, remember to use npx expo login, if you are having problems with npx expo start, you can use --tunnel
